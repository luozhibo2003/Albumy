...
from albumy.forms.user import NotificationSettingForm, UploadAvatarForm, CropAvatarForm, EditProfileForm, \
    ChangePasswordForm, ChangeEmailForm, PrivacySettingForm, DeleteAccountForm
from albumy.models import Collect, User, Photo
from albumy.notifications import push_follow_notification
from albumy.settings import Operations
from albumy.utils import redirect_back, generate_token, flash_errors
...
def index(username):
    ...
    if user == current_user and user.locked:
        flash('您的账户已被锁定，请联系管理员解锁.', 'danger')
